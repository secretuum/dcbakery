...
export default function MainLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      <Footer />
      <a href="#" aria-label="Наверх" className="fixed bottom-32 right-5 z-40 hidden rounded-full bg-white p-3 shadow-lg ring-1 ring-black/10 transition hover:bg-cream xl:flex">

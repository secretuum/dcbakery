...
const faq: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Доставка по Алматы. Точную дату и способ (доставка или самовывоз) менеджер согласует при подтверждении заказа. Приём заявок — накануне дня доставки.",
  },
  {
        ...
        <div className="rounded-card border border-black/10 bg-white p-8 sm:p-10">
          ...
          <p className="mt-4 text-base leading-7 text-dark/80">
            <EditableText
              field="optom.lead"
              multiline
              fallback="DC Bakery — оптовый B2B-поставщик десертов и тортов, замороженных полуфабрикатов (пельмени, манты, самса, чебуреки, сырники, вареники), мяса и банкетных десертов для кофеен, ресторанов, отелей и магазинов в Алматы."
            />
          </p>
        ...
        <div className="rounded-card border border-black/10 bg-white p-8 sm:p-10">
          ...
          <p className="mt-4 text-sm leading-7 text-dark/80">
            <EditableText
              ...
              multiline
              fallback="Кофейням, ресторанам, отелям, магазинам, пекарням и другим корпоративным клиентам (HoReCa) в Алматы. Работаем строго с бизнесом — оптом и по безналичному расчёту."
            />
          </p>
        </div>
        ...
        <div className="rounded-card border border-black/10 bg-white p-8 sm:p-10">
          ...
          <p className="mt-5 text-sm leading-7 text-dark/80">
            <EditableText
              ...
              multiline
              fallback="Минимального заказа нет — заказать можно на любую сумму, действуют тарифы доставки выше. Доставка по Алматы; точную дату и способ (доставка или самовывоз) менеджер согласует при подтверждении заказа."
            />
          </p>

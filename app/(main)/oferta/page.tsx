      ...
      <article className="mx-auto max-w-3xl">
        <div className="rounded-card border border-black/10 bg-white p-8 sm:p-10">
          ...
          <p className="mt-8 text-sm leading-7 text-dark/80">
            ...
            зарегистрированный в качестве индивидуального предпринимателя на основании Талона о
            государственной регистрации №KZ26TWQ02214961 от 26.01.2025, именуемый в дальнейшем
            «Поставщик», настоящей публичной офертой (далее — «Оферта») предлагает юридическим
            лицам и индивидуальным предпринимателям (далее — «Покупатель», совместно — «Стороны»)
            заключить договор поставки продукции на изложенных ниже условиях.
          </p>
          ...
          <div className="mt-10 border-t border-black/10 pt-8">
            ...
            <div className="mt-4 space-y-3 text-sm leading-7 text-dark/80">
              ...
              <p>1.3. Заказ — оформленный Покупателем запрос на поставку Продукции с указанием наименований, количества и условий получения.</p>
              <p>1.4. Акцепт — полное и безоговорочное принятие Покупателем условий настоящей Оферты в порядке раздела 3.</p>
            </div>
          </div>
          ...
          <div className="mt-10 border-t border-black/10 pt-8">
            ...
            <div className="mt-4 space-y-3 text-sm leading-7 text-dark/80">
              ...
              <p>3.3. Поставщик вправе в любое время изменять условия Оферты; действующая редакция размещается на Сайте. К отношениям Сторон применяется редакция, действовавшая на момент оформления соответствующего Заказа.</p>
            </div>
          </div>
          ...
          <div className="mt-10 border-t border-black/10 pt-8">
            ...
            <div className="mt-4 space-y-3 text-sm leading-7 text-dark/80">
              ...
              <p>4.3. Поставщик вправе отказать в подтверждении Заказа либо предложить его корректировку (наличие Продукции, минимальная партия, сроки изготовления и доставки).</p>
            </div>
          </div>
          ...
          <div className="mt-10 border-t border-black/10 pt-8">
            ...
            <div className="mt-4 space-y-3 text-sm leading-7 text-dark/80">
              ...
              <p>6.3. Поставщик вправе в одностороннем порядке вводить, изменять, приостанавливать или досрочно прекращать любые акции, ограничивать круг участников и количество бонусной продукции, разместив информацию на Сайте, без выплаты Покупателю какой-либо компенсации.</p>
              <p>6.4. Бонусная (подарочная) продукция и предоставленные скидки не подлежат обмену, возврату или замене денежной компенсацией. На бонусную (подарочную) продукцию распространяются те же условия приёмки и требования к качеству, что и на основную Продукцию.</p>
              <p>6.5. Если иное прямо не указано в условиях акции, акции и скидки между собой не суммируются. Оформление Заказа в рамках акции означает согласие Покупателя с её условиями.</p>
              <p>6.6. Проводимые акции не являются публичным обещанием награды, публичным конкурсом либо лотереей; предоставление бонусов осуществляется в рамках исполнения настоящего договора.</p>
            </div>
          </div>
          ...
          <div className="mt-10 border-t border-black/10 pt-8">
            ...
            <div className="mt-4 space-y-3 text-sm leading-7 text-dark/80">
              ...
              <p>7.3. Доставка/передача Продукции осуществляется в сроки, согласованные Сторонами при подтверждении Заказа.</p>
              <p>7.4. Право собственности и риск случайной гибели или повреждения Продукции переходят к Покупателю в момент передачи Продукции Покупателю или его уполномоченному представителю.</p>
            </div>
          </div>
          ...
          <div className="mt-10 border-t border-black/10 pt-8">
            ...
            <div className="mt-4 space-y-3 text-sm leading-7 text-dark/80">
              ...
              <p>8.3. Подписание Покупателем товарной накладной подтверждает факт передачи Продукции, соответствие её количества и качества и отсутствие претензий со стороны Покупателя.</p>
            </div>
          </div>
          ...
          <div className="mt-10 border-t border-black/10 pt-8">
            ...
            <div className="mt-4 space-y-3 text-sm leading-7 text-dark/80">
              ...
              <p>9.3. Порча Продукции, нарушение условий или сроков хранения по вине Покупателя не являются основанием для возврата или замены Продукции и оплачиваются Покупателем в полном объёме.</p>
              <p>9.4. Возврат денежных средств по Заказу, оплаченному банковской картой, осуществляется на ту же банковскую карту в срок, установленный правилами платёжной системы и банка-эквайера, как правило до 10 (десяти) рабочих дней с момента согласования возврата.</p>
              <p>9.5. Контакты для претензий: e-mail info@dc-bakery.kz, тел. +7 747 727 2650, +7 747 694 0766.</p>
            </div>
          </div>
          ...
          <div className="mt-10 border-t border-black/10 pt-8">
            ...
            <div className="mt-4 space-y-3 text-sm leading-7 text-dark/80">
              ...
              <p>10.3. Покупатель гарантирует, что действует как юридическое лицо или индивидуальный предприниматель и приобретает Продукцию в предпринимательских целях, а не для личного (потребительского) использования.</p>
            </div>
          </div>
          ...
          <div className="mt-10 border-t border-black/10 pt-8">
            ...
            <div className="mt-4 space-y-3 text-sm leading-7 text-dark/80">
              ...
              <p>11.3. Уплата пени не освобождает Покупателя от исполнения обязательства по оплате.</p>
              <p>11.4. При нарушении Покупателем сроков оплаты Поставщик вправе прекратить сотрудничество (исполнение договора) в одностороннем порядке.</p>
              <p>11.5. Поставщик не несёт ответственности за ненадлежащее хранение Продукции Покупателем после её передачи, а также за реализацию Продукции с истёкшим по вине Покупателя сроком годности.</p>
            </div>
          </div>
          ...
          <div className="mt-10 border-t border-black/10 pt-8">
            ...
            <div className="mt-4 space-y-3 text-sm leading-7 text-dark/80">
              ...
              <p>12.3. Если обстоятельства непреодолимой силы длятся свыше 30 (тридцати) календарных дней, любая из Сторон вправе отказаться от неисполненных обязательств, письменно уведомив другую Сторону, без применения мер ответственности.</p>
            </div>
          </div>
          ...
          <div className="mt-10 border-t border-black/10 pt-8">
            ...
            <div className="mt-4 space-y-3 text-sm leading-7 text-dark/80">
              ...
              <p>13.3. Данные банковских карт Поставщиком не собираются и не хранятся; оплата картой проводится на стороне банка-эквайера (платёжного провайдера).</p>
            </div>
          </div>
          ...
          <div className="mt-10 border-t border-black/10 pt-8">
            ...
            <div className="mt-4 space-y-3 text-sm leading-7 text-dark/80">
              ...
              <p>16.3. Стороны проводят сверку взаиморасчётов (акт сверки) не чаще одного раза в неделю.</p>
              <p>16.4. Уведомления считаются надлежащими, если направлены по контактным данным, указанным Сторонами при оформлении Заказа (e-mail, телефон, WhatsApp).</p>
              <p>16.5. Покупатель не вправе уступать права и переводить обязанности по договору третьим лицам без письменного согласия Поставщика.</p>
              <p>16.6. Признание отдельного положения Оферты недействительным не влечёт недействительности остальных её положений.</p>
              <p>16.7. Настоящая Оферта имеет приоритет над устными договорённостями и представляет собой полное соглашение Сторон в отношении её предмета.</p>
            </div>
          </div>
          ...
          <div className="mt-10 border-t border-black/10 pt-8">
            ...
            <p className="mt-5 text-sm text-muted">
              ...
              Контакты: тел. +7 747 727 2650, +7 747 694 0766; e-mail info@dc-bakery.kz; сайт dc-bakery.kz.
            </p>
          </div>
          ...
          <div className="mt-10 border-t border-black/10 pt-6 text-center">
            <Link href="/contacts" className="text-sm font-bold text-coral hover:underline">

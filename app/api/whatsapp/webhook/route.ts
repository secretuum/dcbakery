...
export async function POST(request: Request) {
  ...
  // Жёстко игнорируем ЧУЖИЕ группы: номер состоит во внутренних WhatsApp-группах
  // «Касса …» (их read-only опрашивает операционный бот operwaz). DC-бот работает
  // только в личных чатах клиентов (@c.us) и в нашей менеджерской группе
  // (GREEN_API_CHAT_ID). Любой другой @g.us — не отвечаем и не обрабатываем.

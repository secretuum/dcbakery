      ...
      <section className="mx-auto max-w-md">
        ...
        <div className="mt-8 rounded-card bg-white p-6 shadow-sm">
          {step === "checking" ? (
            ...
            <>
              <p className="text-sm font-semibold leading-6 text-dark/80">{t("Ссылка недействительна или устарела. Запросите сброс пароля ещё раз на странице входа.")}</p>
              <Link
                href="/profile"
            ...
            <>
              <div className="space-y-3">
                <label className="block">
                  <span className="text-sm font-bold text-dark">{t("Новый пароль")}</span>
                  <Input
                    className="mt-2"
                    type="password"
                    value={password}
                ...
                <label className="block">
                  <span className="text-sm font-bold text-dark">{t("Повторите пароль")}</span>
                  <Input
                    className="mt-2"
                    type="password"

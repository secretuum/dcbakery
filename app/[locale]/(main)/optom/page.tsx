...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description = t(
    "Оптовые поставки десертов, полуфабрикатов и мяса для кофеен, ресторанов и отелей Алматы. Минимальный заказ 15 000 ₸, бесплатная доставка, оплата по счёту.",
  );
        ...
        <div className="rounded-card border border-black/10 bg-white p-8 sm:p-10">
          ...
          <p className="mt-4 text-base leading-7 text-dark/80">
            <EditableText
              ...
              multiline
              fallback={t(
                "DC Bakery — оптовый B2B-поставщик десертов и тортов, замороженных полуфабрикатов (пельмени, манты, самса, чебуреки, сырники, вареники) и мяса для кофеен, ресторанов, отелей и магазинов в Алматы.",
              )}
            />
          </p>
        ...
        <div className="rounded-card border border-black/10 bg-white p-8 sm:p-10">
          ...
          <p className="mt-4 text-sm leading-7 text-dark/80">
            <EditableText
              ...
              multiline
              fallback={t(
                "Десерты и торты, замороженные полуфабрикаты (пельмени, манты, самса, чебуреки, сырники, вареники) и мясо с халал-сертификатами. Полный ассортимент с оптовыми ценами и остатками — в каталоге.",
              )}
            />
          </p>

...
export default async function Home() {
  const [categories, allProducts, content, isSuperAdmin] = await Promise.all([
    fetchCategories(),
    fetchProducts(),
    getSiteContent(),
    getIsSuperAdmin(),
            ...
            <div className="grid items-end gap-10 lg:grid-cols-[1fr_auto]">
              <div>
                ...
                <h1 className="mt-4 font-display text-4xl font-semibold leading-tight tracking-tight sm:text-5xl lg:text-[3.25rem]">
                  <EditableText field="heroTitle" fallback={content.heroTitle} multiline />
                </h1>
                <p className="mt-5 max-w-xl text-base leading-7 text-muted">
                  <EditableText field="heroSubtitle" fallback={content.heroSubtitle} multiline />
                </p>
        ...
        <section id="about" className="border-t border-black/10 bg-white px-5 py-14 lg:px-8 lg:py-20">
          <div className="mx-auto max-w-7xl">
            ...
            <h2 className="mt-3 font-display text-2xl font-semibold tracking-tight lg:text-3xl">
              <EditableText field="aboutTitle" fallback={content.aboutTitle} />
            </h2>
            <p className="mt-4 max-w-2xl text-sm leading-7 text-muted">
              <EditableText field="aboutText" fallback={content.aboutText} multiline />
            </p>
